  ...
  return (
    <div className="min-h-screen font-sans text-[#dae2fd] antialiased overflow-x-hidden flex flex-col bg-[#0b1326]">
      ...
      <header className="bg-surface border-b border-outline-variant flex justify-between items-center px-container-margin w-full max-w-full mx-auto h-16 z-50 flex-nowrap overflow-hidden">
        ...
        <nav className="hidden md:flex space-x-6 lg:space-x-8 flex-shrink-0">
          <a
        ...
        <div className="flex items-center space-x-4 lg:space-x-6 flex-shrink-0">
          <span className="text-on-surface-variant font-label-md text-label-md hidden md:inline-block whitespace-nowrap">
            January 1, 2026
          </span>
          <div className="flex items-center space-x-3 flex-shrink-0">
            <div className="text-right hidden sm:block flex-shrink-0">
              <div className="text-on-surface font-label-md text-label-md whitespace-nowrap">
                Sarah Chen
              </div>
