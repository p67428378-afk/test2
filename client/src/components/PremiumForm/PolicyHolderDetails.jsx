    ...
    return (
        <section className="flex flex-col gap-md">
            <div className="flex items-center gap-sm border-b border-outline-variant pb-sm">
                ...
                <h2 className="font-label-md text-label-md uppercase tracking-wider text-on-surface-variant">Policy Holder Details</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-lg">
                ...
                <div className="flex flex-col gap-xs md:col-span-2">
                    <label className="font-label-md text-label-md text-on-surface">Driving Experience (Years)</label>
                    <input
