...
const PremiumForm = ({ onCalculate }) => {
  ...
  return (
    <form
      ...
      className="bg-surface border border-outline-variant rounded-xl p-lg shadow-sm flex flex-col gap-xl"
    >
      ...
      <div className="pt-lg flex justify-center">
        <button
          type="submit"
          className="bg-[#3B82F6] text-white px-[48px] py-[16px] rounded-lg font-headline-md text-headline-md shadow-lg hover:shadow-xl hover:brightness-110 active:scale-95 transition-all w-full md:w-auto"
        >
          Calculate Premium
        </button>
      </div>
