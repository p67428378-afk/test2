                ...
                <div>
                    <div className='flex justify-between items-start mb-12 relative z-10'>
                        <div>
                            ...
                            <h2 className='text-3xl font-extrabold mt-1'>Platinum Health Plan</h2>
                        </div>
                    ...
                    <div className='space-y-8 relative z-10'>
                        <div>
                            ...
                            <p className='text-4xl font-black'>$450<span className='text-lg font-normal opacity-80'>/mo</span></p>
                        </div>
                        <div className='flex gap-12'>
                            <div>
                                <p className='text-sm opacity-70 mb-1'>Effective From</p>
                                <p className='font-bold'>Jan 1, 2024</p>
                            </div>
                            <div>
