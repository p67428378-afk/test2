# Todo List Application Management (SCRUM-158)

A modern, responsive full-stack task management application with a FastAPI backend and React 18/Vite/Tailwind CSS frontend.
...
```bash
# From repository root or server/ directory:
