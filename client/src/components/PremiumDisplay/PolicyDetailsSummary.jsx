        ...
        <div className="mt-xl">
            ...
            <div className="bg-surface-container-low border border-outline-variant rounded-xl p-lg divide-y divide-outline-variant">
                <div className="py-sm flex justify-between items-center">
                    <span className="font-label-md text-label-md text-on-surface-variant">Policy ID</span>
                    <span className="font-body-sm text-body-sm text-on-surface font-semibold truncate">{policyId}</span>
                </div>
