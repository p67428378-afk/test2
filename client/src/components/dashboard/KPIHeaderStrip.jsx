      ...
      <div className="bg-amber-900/20 border border-amber-700/50 rounded-lg p-5 flex flex-col justify-between h-32 relative overflow-hidden">
        <div className="flex flex-col gap-1 w-full">
          <div className="flex justify-between items-center w-full gap-2">
            <span className="font-label-caps text-label-caps text-slate-400 text-sm">
              Private Brand %
            </span>
            <span className="text-[10px] font-semibold px-2 py-0.5 bg-amber-500/20 text-amber-400 rounded shrink-0 whitespace-nowrap">
              Below 25% Target
            </span>
          </div>
        </div>
        <div className="font-display-kpi text-display-kpi text-white mt-auto font-bold text-4xl">
