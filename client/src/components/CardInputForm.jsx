...
const CardInputForm = ({ onSubmit, isSubmitting, error }) => {
  ...
  return (
    <div id="setup-view">
      <h1 className="text-headline-md font-headline-md text-on-surface mb-xl">
        Set Up Debit Card Spend Alert
      </h1>
      <form className="space-y-xl" onSubmit={handleSubmit}>
        ...
        <div className="space-y-xs">
          ...
          <div className="relative">
            <span className="absolute left-md top-1/2 -translate-y-1/2 text-on-surface-variant font-body-md">
              $
            </span>
            <input
