          ...
          return (
            ...
            >
              ...
              {isSelected && projections && (
                <div className="mt-3 pt-2 border-t border-outline-variant/30 grid grid-cols-3 gap-1 -mx-1 text-center">
                  <div className="px-1">
                    <div className="text-[9px] tracking-tight leading-tight text-secondary uppercase font-semibold">
                      Sales Lift
                    </div>
