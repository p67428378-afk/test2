      ...
      <div>
        ...
        <div className='space-y-4 mb-6 border-t border-b border-[#334155] py-4'>
          <div className='flex justify-between items-center'>
            <span className='text-xs text-on-surface-variant uppercase tracking-wider font-semibold'>Projected Sales Lift</span>
            <span className='text-lg font-bold text-[#10B981]'>+{projected_sales_lift}%</span>
          </div>
          <div className='flex justify-between items-center'>
            <span className='text-xs text-on-surface-variant uppercase tracking-wider font-semibold'>Projected Margin</span>
            <span className='text-lg font-bold text-on-surface'>{projected_profit_margin}%</span>
          </div>
          <div className='flex justify-between items-center'>
            <span className='text-xs text-on-surface-variant uppercase tracking-wider font-semibold'>Private Brand %</span>
            <span className='text-lg font-bold text-primary-fixed-dim'>{new_private_brand_percent}%</span>
          </div>
        </div>
        ...
        <div className='grid grid-cols-3 gap-2 text-center mb-6'>
          <div className='bg-surface-container-low p-2 rounded border border-[#334155]'>
            <div className='text-xs text-on-surface-variant font-semibold uppercase tracking-wider'>Add</div>
            <div className='text-lg font-bold text-[#10B981] mt-1'>+{skus_to_add}</div>
          </div>
          <div className='bg-surface-container-low p-2 rounded border border-[#334155]'>
            <div className='text-xs text-on-surface-variant font-semibold uppercase tracking-wider'>Remove</div>
            <div className='text-lg font-bold text-[#EF4444] mt-1'>-{skus_to_remove}</div>
          </div>
          <div className='bg-surface-container-low p-2 rounded border border-[#334155]'>
            <div className='text-xs text-on-surface-variant font-semibold uppercase tracking-wider'>Swap</div>
            <div className='text-lg font-bold text-[#F59E0B] mt-1'>{skus_to_swap}</div>
          </div>
        </div>
      </div>
