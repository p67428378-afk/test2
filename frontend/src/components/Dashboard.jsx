    ...
    <div className='bg-surface text-on-surface'>
      <aside className='h-screen w-64 fixed left-0 top-0 border-r-0 bg-slate-50 dark:bg-slate-900 flex flex-col h-full py-8 px-4 z-50 tonal-shift bg-slate-100'>
        ...
        <nav className='flex-1 space-y-2'>
          <Link className='flex items-center gap-3 px-4 py-3 rounded-lg text-cyan-700 font-semibold border-r-4 border-cyan-700 bg-slate-200/50 transition-colors' to='/'>
            <span className='material-symbols-outlined' data-icon='dashboard'>dashboard</span>
            <span className='font-body'>Dashboard</span>
          </Link>
          <Link className='flex items-center gap-3 px-4 py-3 rounded-lg text-slate-500 hover:text-cyan-600 hover:bg-slate-200/50 transition-colors' to='/update'>
            <span className='material-symbols-outlined' data-icon='receipt_long'>receipt_long</span>
            <span className='font-body'>Update Policy</span>
          </Link>
          <Link className='flex items-center gap-3 px-4 py-3 rounded-lg text-slate-500 hover:text-cyan-600 hover:bg-slate-200/50 transition-colors' to='/cancel'>
            <span className='material-symbols-outlined' data-icon='medical_services'>medical_services</span>
            <span className='font-body'>Cancel Policy</span>
          </Link>
        </nav>
