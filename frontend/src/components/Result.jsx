...
const Result = ({ result }) => {
  ...
  const { eligibility_status, interest_rate, ineligibility_reasons } = result;
    ...
    <section className='space-y-4'>
      ...
      {eligibility_status ? (
          ...
          <div className='p-6 relative z-10'>
            <div className='flex items-center gap-3 mb-6'>
              ...
              <div>
                ...
                <p className='text-white font-headline font-extrabold text-xl'>Approved</p>
              </div>
            </div>
            <div className='bg-white/10 backdrop-blur-md rounded-lg p-4 border border-white/10'>
              ...
              <div className='flex items-baseline gap-2'>
                <p className='text-3xl font-headline font-black text-white'>{interest_rate}%</p>
        ...
        <div className='bg-error-container/30 rounded-xl p-6 border-l-4 border-error space-y-4'>
          ...
          <p className='text-on-surface-variant text-sm'>Our automated system identified the following constraints:</p>
          <ul className='space-y-3'>
            {ineligibility_reasons && ineligibility_reasons.map((reason, index) => (
