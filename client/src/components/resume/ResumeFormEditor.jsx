...
import TemplateCardGrid from "../templates/TemplateCardGrid";
      ...
      <div className="p-4 sm:p-6 border-b border-slate-200 bg-slate-50 flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Fill in your experience, education, and skills to update your CV in
            real time.
          </p>
        </div>
      ...
      <div className="p-4 sm:p-6 space-y-6">
            ...
            {!resumeData.experiences || resumeData.experiences.length === 0 ? (
              <div className="text-center py-8 px-4 border-2 border-dashed border-slate-200 rounded-lg">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Click "Add Position" above to add your employment history.
                </p>
              </div>
            ) : (
              <div className="space-y-6">
          ...
          <div className="space-y-6">
            ...
            {!resumeData.education || resumeData.education.length === 0 ? (
              <div className="text-center py-8 px-4 border-2 border-dashed border-slate-200 rounded-lg">
                ...
                <p className="text-xs text-slate-400 mt-1">
                  Click "Add Education" to include your degree or program.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
        ...
        {activeTab === "templates" && (
          <div className="space-y-4">
            ...
            <TemplateCardGrid
              selectedTemplate={resumeData.template_id || "classic"}
