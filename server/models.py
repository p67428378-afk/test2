...
class PerformanceMetric(Base):
    ...
    trend_direction = Column(String(50), default="Flat", nullable=False) # Up, Down, Flat
...
class AuditTrail(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    scenario_id = Column(UUID(as_uuid=True), ForeignKey("assortment_scenarios.id"), nullable=False)
