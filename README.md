# CRUD-Based TODO List Application

A full-stack web application for managing daily tasks and priorities with full CRUD functionality.
...
- `ALLOWED_ORIGINS`: Comma-separated CORS allowed origins (default: `http://localhost:5173,http://localhost:3000`)
